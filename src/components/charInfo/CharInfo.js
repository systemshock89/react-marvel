...
const CharInfo = (props) => {
    ...
    const [loading, setLoading] = useState(false); // этот компонент при загрузке страницы не должен загружаться. Там должна быть заглушка. А загрузка произойдет по действию пользователя
